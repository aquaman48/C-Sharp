...
namespace ReceiptApp
{
    class ReceiptApp
    {
        ...
        {
            OutputEncoding = System.Text.Encoding.UTF8; //for Euro symbol print
            ...
            "\nTotal Cost (Dollar): {0}", secondReceiptObject.CalculateTotalCost().ToString("c"));
            WriteLine("Total Cost (Euro): {0}", secondReceiptObject.CurrencyConversion().ToString("c", euCurrency));
            ...
            "\nTotal Cost(Dollar): " + lastReceiptObject.CalculateTotalCost().ToString("C") +
            "\nTotal Cost(Euro): " + lastReceiptObject.CurrencyConversion().ToString("C", euCurrency));
