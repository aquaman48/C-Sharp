    ...
    class CalculateAverage
    {
        static void Main()
        {
            ...
            do
            {
                ...
                average = CalculateAverages(countOfScoresEntered, totalScoresPerStudent);
        ...
        static void DisplayInstructions()
        {
            WriteLine("****************************************************************************" +
                ...
                "\n***   The scores entered will be averages and a letter grade             ***" +
                "\n***   assinged. The results will then be displayed. You may enter        ***" +
        ...
        static bool GetInput() 
        {
            ...
            if (char.TryParse(ReadLine(), out input) == false) //In case they enter more than one char. 
                input = 'n';
            switch(input)
            {
                case 'y':
        ...
        static double CalculateAverages(int numberOfScores, int totalScores)
        {
            double average;
            if (numberOfScores > 0)
